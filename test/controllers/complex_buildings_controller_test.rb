...
class ComplexBuildingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complex_building" do
    assert_difference('ComplexBuilding.count') do
      post complex_buildings_url, params: { complex_building: { address: @complex_building.address, owner: @complex_building.owner, price: @complex_building.price, sqmt: @complex_building.sqmt, units: @complex_building.units } }
    end
  ...
  test "should update complex_building" do
    patch complex_building_url(@complex_building), params: { complex_building: { address: @complex_building.address, owner: @complex_building.owner, price: @complex_building.price, sqmt: @complex_building.sqmt, units: @complex_building.units } }
