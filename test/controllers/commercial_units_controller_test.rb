...
class CommercialUnitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commercial_unit" do
    assert_difference('CommercialUnit.count') do
      post commercial_units_url, params: { commercial_unit: { address: @commercial_unit.address, owner: @commercial_unit.owner, parking: @commercial_unit.parking, photo: @commercial_unit.photo, price: @commercial_unit.price, shops: @commercial_unit.shops, sqmt: @commercial_unit.sqmt } }
    end
  ...
  test "should update commercial_unit" do
    patch commercial_unit_url(@commercial_unit), params: { commercial_unit: { address: @commercial_unit.address, owner: @commercial_unit.owner, parking: @commercial_unit.parking, photo: @commercial_unit.photo, price: @commercial_unit.price, shops: @commercial_unit.shops, sqmt: @commercial_unit.sqmt } }
